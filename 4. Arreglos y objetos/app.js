...
//En js se pueden realizar arreglos con diferentes tipos de datos (como string, number, etc.) incluyendo arreglos
const variosDatos = [
  "A",
  "Dato caracter o string",
  2356,
  true,
  ["Liliana", 32, ["Comida favorita", "Cancion favorita"]],
];
console.log(variosDatos);
console.log(variosDatos[2]);

// Se pueden acceder a elementos de arreglos que estén dentro del arreglo principal añadiendo otro [X] con el id del elemento que esté asignado en el arreglo después del primer [N] que defina el arreglo
console.log(variosDatos[4][1]);
console.log(variosDatos[4][2][0]);

//Metodos para manipulación de arreglos:
/*Se pueden manipular los elementos dentro de un arreglo ya creado mediante los comandos Push, Pop y Splice */
...
const informacion = [
  ...
  "Herrera",
  32,
  "docentelherrera@udistrital.edu.co",
  3124597,
];
...
//Foreach: es una estructura de control especialmente útil para estructuras de datos compuestas como los arreglos
...
console.log(
  `El año del vehiculo es ${carro.anio} y la marca es ${carro.marca}. Los dueños son:`
);
...
console.log(mascota);
console.log(
  `El telefono del dueño de la mascota ${mascota.nombre} es: ${mascota.duenio.contacto.telefono}`
);
